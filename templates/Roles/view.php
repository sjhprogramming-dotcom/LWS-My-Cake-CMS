    ...
    <div class="column column-80">
        <div class="roles view content">
            ...
            <table>
                ...
                <tr>
                    <th><?= __('IsAdmin') ?></th>
                    <td><?= $role->isAdmin ? __('Yes') : __('No'); ?></td>
                </tr>
                <tr>
                    <th><?= __('IsModerator') ?></th>
                    <td><?= $role->isModerator ? __('Yes') : __('No'); ?></td>
                </tr>
                <tr>
                    <th><?= __('IsUser') ?></th>
                    <td><?= $role->isUser ? __('Yes') : __('No'); ?></td>
                </tr>
            </table>
            <div class="text">
                ...
                <div class="table-responsive">
                    <table>
                        <tr>
                            ...
                            <th><?= __('Modified') ?></th>
                            <th><?= __('IsActive') ?></th>
                            <th><?= __('ActivationToken') ?></th>
                            <th><?= __('ActivationTokenExpiry') ?></th>
                        ...
                        <tr>
                            ...
                            <td><?= h($user->activationToken) ?></td>
                            <td><?= h($user->activationTokenExpiry) ?></td>
                            <td class="actions">
