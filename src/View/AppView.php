...
class AppView extends View
{
    ...
    public function initialize(): void
    {
        ...
        $this->Paginator->setTemplates([
            ...
            'sort' => '<a href="{{url}}">{{text}}<span class="visually-hidden"> (sortable)</span></a>',
            'sortAsc' => '<a class="asc" href="{{url}}">{{text}}<span class="visually-hidden"> (sorted ascending)</span></a>',
            'sortDesc' => '<a class="desc" href="{{url}}">{{text}}<span class="visually-hidden"> (sorted descending)</span></a>',
